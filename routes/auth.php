...
use App\Http\Controllers\Auth\PatientController as AuthPatientController;
...
Route::middleware('guest')->group(function () {
    ...
    Route::post('login/patient', [AuthPatientController::class, 'store'])->name('login.patient');
    Route::post('logout/patient', [AuthPatientController::class, 'destroy'])->middleware('auth:patient')->name('logout.patient');
