...
class PaymentRepository implements PaymentRepositoryInterface
{
    ...
    {
        // return PaymentAccount::with('patients')->get();
        $patients = PaymentAccount::with('patients')->get();
    ...
    public function store($request)
    {
        ...
        try {
            ...
            // v2
            // $request->merge(['data' => date('y-m-d')]);
            // $payment_accounts = PaymentAccount::create($request->only(''));
