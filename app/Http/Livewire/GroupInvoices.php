...
class GroupInvoices extends Component
{
        ...
        if ($this->type == 1) {
            ...
            try {
                ...
                if ($this->updateMode) {
                    ...
                    $group_invoices->section_id = DB::table('section_tanslations')->where('name', $this->section_id)->first()->section_id;
    ...
    public function edit($id)
    {
        ...
        $this->section_id = DB::table('section_tanslations')->where('id', $group_invoices->section_id)->first()->name;
