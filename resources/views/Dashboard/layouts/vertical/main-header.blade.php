           ...
           <div class="main-header-left ">
               <div class="responsive-logo">
                   <a href="{{ url('index') }}"><img src="{{ asset('assets/img/brand/logo.png') }}" class="logo-1"
                           alt="logo"></a>
                   <a href="{{ url('index') }}"><img src="{{ asset('assets/img/brand/logo-white.png') }}"
                           class="dark-logo-1" alt="logo"></a>
                   <a href="{{ url('index') }}"><img src="{{ asset('assets/img/brand/favicon.png') }}" class="logo-2"
                           alt="logo"></a>
                   <a href="{{ url('index') }}"><img src="{{ asset('assets/img/brand/favicon-white.png') }}"
               ...
               <ul class="nav nav-item  navbar-nav-right ms-auto">
                   ...
                   <li class="dropdown nav-item main-header-notification">
                       ...
                       <div class="dropdown-menu dropdown-notifications">
                           <div class="menu-header-content bg-primary text-start">
                               <div class="d-flex">
                                   <h6 class="dropdown-title mb-1 tx-15 text-white fw-semibold">الاشعارات
                                   </h6>
                                   <span class="badge rounded-pill bg-warning ms-auto my-auto float-end">Mark
                                       All Read</span>
                               </div>
                           ...
                           <div class="main-notification-list Notification-scroll">
                               ...
                               @foreach (App\Models\Notification::where('user_id', auth()->user()->name)->where('reader_status', 0)->get() as $notification)
                                   <a class="d-flex p-3 border-bottom" href="#">
                                       <div class="notifyimg bg-pink">
                                           <i class="la la-file-alt text-white"></i>
                                       </div>
                   ...
                   <li class="dropdown main-profile-menu nav nav-item nav-link">
                       ...
                       <div class="dropdown-menu">
                           ...
                           <a class="dropdown-item" href="{{ url('editprofile') }}"><i class="bx bx-cog"></i>تعديل
                               الملف الشخصي</a>
                           @if (auth('web')->check())
                           ...
                           @elseif (auth('ray_employee')->check())
                               <a class="dropdown-item" href="{{ route('ray_employee.logout') }}"><i
                                       class="bx bx-log-out"></i> تسجيل الخروج</a>
                           @elseif (auth('laboratorie_employee')->check())
                               <a class="dropdown-item" href="{{ route('laboratorie_employee.logout') }}"><i
                                       class="bx bx-log-out"></i> تسجيل الخروج</a>
                           @elseif (auth('patient')->check())
                               <a class="dropdown-item" href="{{ route('patient.logout') }}"><i
                                       class="bx bx-log-out"></i> تسجيل الخروج</a>
                           @endif
   ...
   <script>
       ...
       channel.bind('my-invoice', function(data) {
           var test = App / Models / Invoice::class;
           // هاد للبرايفيت
