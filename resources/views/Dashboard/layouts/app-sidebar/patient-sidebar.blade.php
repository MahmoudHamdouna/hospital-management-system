   ...
   <aside class="app-sidebar sidebar-scroll">
       <div class="main-sidebar-header active">
           <a class="desktop-logo logo-light active" href="{{ url('index') }}"><img
           ...
           <a class="logo-icon mobile-logo icon-dark active" href="{{ url('index') }}"><img
           ...
           <ul class="side-menu">
               ...
               <li class="slide">
                   <a class="side-menu__item" href="{{ route('dashboard.ray_employee') }}"><svg
                       ...
                       </svg><span class="side-menu__label">{{ trans('Dashboard/main-sidebar_trans.index') }}</a>
               </li>
               ...
               <li class="slide">
                   ...
                   <ul class="slide-menu">
                       <li><a class="slide-item" href="{{ route('invoices.patient') }}">قائمةالفواتير</a>
                       </li>
                       <li><a class="slide-item" href="{{ route('laboratories.patient') }}">المختبر</a>
                       </li>
               ...
               <li class="slide">
                   ...
                   <ul class="slide-menu">
                       <li><a class="slide-item" href="{{ route('list.doctor') }}">قائمةالاطباء</a>
                       </li>
                       <li><a class="slide-item" href="{{ route('laboratories.patient') }}">المحادثات الاخيرة</a>
                       </li>
                   </ul>
               </li>
