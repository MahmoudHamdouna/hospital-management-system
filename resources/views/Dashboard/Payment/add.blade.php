                        ...
                        <div class="pd-30 pd-sm-40 bg-gray-200">
                            ...
                            <div class="row row-xs align-items-center mg-b-20">
                                ...
                                <div class="col-md-11 mg-t-5 mg-md-t-0">
                                    ...
                                    <select name="patient_id" id='sel_emp' style='width: 100%;'>
                            ...
                            <button
                                type="submit"class="btn btn-main-primary pd-x-30 mg-r-5 mg-t-5">{{ trans('Doctors.submit') }}</button>
                        </div>
                    </form>
                </div>
            </div>
