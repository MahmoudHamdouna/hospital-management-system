...
@section('class')
                                        ...
                                        <div class="card-sigin">
                                            <div class="main-signup-header">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-select" id="sectionChosser">
                                                        ...
                                                        <option value="doctor">الدخول دكتور
                                                        </option>
                                                        <option value="ray_employee">موظف اشعة
                                                        </option>
                                                        <option value="laboratorie_employee">موظف مختبر
                                                        </option>
                                                    </select>
                                                </div>
                                                {{-- Form-user --}}
                                                <div class="loginform" id="user">
                                                    <h2 class="fw-semibold mb-4">الدخول كمريض</h2>
                                                    <form method="POST" action="{{ route('login.patient') }}">
                                                        ...
                                                        <div class="row row-xs">
                                                            <div class="col-sm-6">
                                                                <a href="{{ url('index') }}" class="btn btn-block"><i
                                                                        class="fab fa-facebook-f"></i> Signup with
                                                                    Facebook</a>
                                                            </div>
                                                            <div class="col-sm-6 mg-t-10 mg-sm-t-0">
                                                                <a href="{{ url('index') }}"
                                                                    class="btn btn-info btn-block btn-b"><i
                                                                        class="fab fa-twitter"></i> Signup with Twitter</a>
                                                            </div>
                                                        </div>
                                                    </form>
                                                ...
                                                <div class="loginform" id="admin">
                                                    <h2 class="fw-semibold mb-4">الدخول كادمن</h2>
                                                ...
                                                <div class="loginform" id="doctor">
                                                    <h2 class="fw-semibold mb-4">الدخول دكتور</h2>
                                                ...
                                                <div class="loginform" id="ray_employee">
                                                    <h2 class="fw-semibold mb-4">موظف اشعة</h2>
                                                ...
                                                <div class="loginform" id="laboratorie_employee">
                                                    <h2 class="fw-semibold mb-4">موظف مختبر</h2>
                                                    <form method="POST"
                                                        action="{{ route('login.laboratorie_employee') }}">
                                                        @csrf
                                                        <div class="form-group">
                                                            <label>Email</label> <input class="form-control"
                                                                placeholder="Enter your email" type="email"
    ...
    @section('scripts')
        <script>
            $('#sectionChosser').change(function() {
                var myID = $(this).val();
