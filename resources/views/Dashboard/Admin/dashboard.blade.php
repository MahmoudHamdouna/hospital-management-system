            ...
            <div class="card overflow-hidden sales-card bg-primary-gradient">
                <div class="ps-3 pt-3 pe-3 pb-2 pt-0">
                    ...
                    <div class="pb-0 mt-0">
                        <div class="d-flex">
                            <div class="">
                                <h4 class="tx-20 fw-bold mb-1 text-white">{{ \App\Models\Doctor::count() }}</h4>
                            </div>
            ...
            <div class="card overflow-hidden sales-card bg-danger-gradient">
                <div class="ps-3 pt-3 pe-3 pb-2 pt-0">
                    ...
                    <div class="pb-0 mt-0">
                        <div class="d-flex">
                            <div class="">
                                <h4 class="tx-20 fw-bold mb-1 text-white">{{ \App\Models\Patient::count() }}</h4>
                            </div>
            ...
            <div class="card overflow-hidden sales-card bg-success-gradient">
                <div class="ps-3 pt-3 pe-3 pb-2 pt-0">
                    ...
                    <div class="pb-0 mt-0">
                        <div class="d-flex">
                            <div class="">
                                <h4 class="tx-20 fw-bold mb-1 text-white">{{ \App\Models\Section::count() }}</h4>
                            </div>
                ...
                <div class="card-body p-0 customers mt-1">
                    <div class="list-group list-lg-group list-group-flush">
                                ...
                                <div class="media-body">
                                    <div class="d-flex align-items-center">
                                        <div class="mt-1">
                                            ...
                                            <p class="mb-0 tx-13 text-muted">User ID: #1234 <span
                                                    class="text-danger  m-l-2">Pending</span></p>
                                        </div>
                                        <span class="ms-auto wd-45p fs-16 mt-2">
                        ...
                        <div class="list-group-item list-group-item-action br-t-1 br-br-7 br-bl-7" href="#">
                            <div class="media mt-0">
                                <img class="avatar-lg rounded-circle m-r-3 my-auto"
                                    src="{{ asset('assets/img/faces/6.jpg') }}" alt="Image description">
                                <div class="media-body">
                                    <div class="d-flex align-items-center">
                                        <div class="mt-1">
                ...
                <div class="product-timeline card-body pt-2 mt-1">
                    <ul class="timeline-1 mb-0">
                        <li class="mt-0" id="mrg-8"> <i
                                ...
                                class="float-left tx-11 text-muted">3 ago days</a>
                        ...
                        <li class="mt-0" id="mrg-8"> <i
                                ...
                                class="float-left tx-11 text-muted">35 ago mins</a>
                        ...
                        <li class="mt-0" id="mrg-8"> <i
                                ...
                                class="float-left tx-11 text-muted">50 ago mins</a>
                        ...
                        <li class="mt-0" id="mrg-8"> <i
                                ...
                                class="float-left tx-11 text-muted">1 ago hour</a>
