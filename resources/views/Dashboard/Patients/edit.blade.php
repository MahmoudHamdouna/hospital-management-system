            ...
            <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col">
                            ...
                            <input class="form-control fc-datepicker" value="{{$Patient->Date_Birth}}" name="Date_Birth" type="date" required>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col">
                            ...
                            <select class="form-control" name="Gender" required>
                                ...
                                <option value="2" {{$Patient->Gender == 2 ? 'selected':''}}>انثى</option>
                            </select>
                        </div>
