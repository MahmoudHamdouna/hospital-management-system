        ...
        <div class="modal-content">
            ...
            <form action="{{ route('Doctors.destroy', 'test') }}" method="post">
                ...
                <div class="modal-body">
                    <h5>{{ trans('doctors.Warning') }} {{ $doctor->name }}</h5>
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary"
                        data-dismiss="modal">{{ trans('doctors.Close') }}</button>
                    <button type="submit" class="btn btn-danger">{{ trans('doctors.submit') }}</button>
                </div>
            </form>
        </div>
    </div>
